#ifndef GUARD_COMFY_ANIM_H
#define GUARD_COMFY_ANIM_H
...
// HnS: heap-allocated, not a static EWRAM array (see docs/PORT_PLAN_SOULGOLD_FEATURES.md
// §5.5) - the array of 8 costs ~448 bytes, which does not fit in HnS's ~976 free bytes
// of EWRAM headroom. Callers must InitComfyAnims() before use and FreeComfyAnims() when
// done, following the same lifecycle as e.g. sPartyMenuInternal in party_menu.c.
extern struct ComfyAnim *gComfyAnims;

void InitComfyAnims(void);
void FreeComfyAnims(void);
